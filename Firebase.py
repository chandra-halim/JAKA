...
# cred = credentials.Certificate("jaka-rpl-firebase-adminsdk-lve41-dbf46068d7.json")

# # Initialize the app with a service account, granting admin privileges
# firebase_admin.initialize_app(cred, {
#     'databaseURL': 'https://jaka-rpl-default-rtdb.asia-southeast1.firebasedatabase.app/'
# })

# Configuration Key
firebaseConfig = {
  'apiKey': "AIzaSyCZL9AmKelefx34vj8tDaKjEOhOI7aFs5U",
  'authDomain': "jaka-ui.firebaseapp.com",
  'projectId': "jaka-ui",
  'databaseURL': "https://jaka-ui-default-rtdb.asia-southeast1.firebasedatabase.app/",
  'storageBucket': "jaka-ui.appspot.com",
  'messagingSenderId': "1007917361138",
  'appId': "1:1007917361138:web:0884e5fc2cc5dca2ef2d6b",
  'measurementId': "G-BJSSKJ4ZF0"
}
...
# Authentication
choice = st.sidebar.selectbox('login/Signup', ['Login', 'Sign up', 'Masuk'])
